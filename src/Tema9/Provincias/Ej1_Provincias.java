...
public class Ej1_Provincias {
    ...
    private static void borradoValor(String provincia) {
        ...
        String pro = "";
        while (claves.hasNext() && !pro.equalsIgnoreCase(provincia)) {
